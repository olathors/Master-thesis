...
class MRI_Dataset(Dataset):
    ...
    def __init__(self, annotations_file, img_dir, device, transform=None, target_transform=None, slice = None, orientation = None, triple = False):
...
class MRI_Dataset_combined(Dataset):
