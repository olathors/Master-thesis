...
class RocCurveDisplay(_BinaryClassifierCurveDisplayMixin):
    ...
    def __init__(self, *, fpr, tpr, roc_auc=None, estimator_name=None, pos_label=None, list = None):
    ...
    def plot(
        ...
        **kwargs : dict
        ...
        if self.roc_auc is not None and name is not None:
            default_line_kwargs["label"] = f"{name} (AUC = {list:0.3f})"
        elif self.roc_auc is not None:
            default_line_kwargs["label"] = f"AUC = {list:0.3f}"
